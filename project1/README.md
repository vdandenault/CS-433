...
```markdown
- _run.py_ produces the predictions of the best submission to the competition system (logistic regression, gamma = 0.001, 100 iterations). The predictions are saved in a file "Submission_logistic_regression_100.csv" saved in the Results folder.
